...
def _no_pin_memory():
    ...
    # PIN_MEMORY so vllm's ExtractHiddenStatesProposer.__init__ creates
    # CpuGpuBuffer with pin_memory=False. Current vLLM resolves this flag at
    # module import and no longer exposes is_pin_memory_available here.
    with patch(
